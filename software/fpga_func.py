...
class FpgaFunc:
    ...
    def access_reg(self):
        ...
        self.trans.wdata_fifoa_append(0x14,0x0090,w_to_reg)        # Set Start Bit
    ...
    # def power_measure(self,activations:bytearray, weights:bytearray):
    #     self.trans.update_wires()
    ...
    #     w_to_reg_p=bytearray(0)         
    #     for _ in range(0xFFFFFF):
    #         self.trans.wdata_fifoa_append(0x24,0x0002,w_to_reg_p) 
    #     self.trans.pipe_data_in(w_to_reg_p)
    #     time.sleep(50)
