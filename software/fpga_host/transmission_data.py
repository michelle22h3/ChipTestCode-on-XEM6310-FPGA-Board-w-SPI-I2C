...
class TransData:
    ...
    def ind_read_reg(self, ind_addr:int, data_twobyte):
        """With an 8-b addr, 16-b data, perform an indirect writing process"""
        ...
        self.logger.debug('Read out data: {} from Address {}'.format(data_twobyte, hex(ind_addr)))
    # ----------------------------------------------------#
